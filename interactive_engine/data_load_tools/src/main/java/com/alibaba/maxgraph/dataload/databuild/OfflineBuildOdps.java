    ...
    public static void main(String[] args)
        ...
        for (Map.Entry<String, GraphElement> entry : tableType.entrySet()) {
            if (entry.getValue() instanceof GraphVertex) {
                ...
                System.out.println(VERTEX_TABLE_NAME+": "+ entry.getKey());
            ...
            if (entry.getValue() instanceof GraphEdge) {
                ...
                System.out.println(EDGE_TABLE_NAME+": "+ entry.getKey());
                InputUtils.addTable(TableInfo.builder().tableName(entry.getKey()).build(), job);
            }
        }
        ...
        String dataPath = ossBucketName + "/" + ossObjectName;
        ...
        //    file.createNewFile();
        //}
        //fos.write(objectMapper.writeValueAsString(outputMeta).getBytes());
        //fos.flush();
        //fos.close();
        ...
        //System.out.println(ossEndPoint+" "+ossAccessId+" "+ossAccessKey);
        //try {
        //    ossClient = new OSSClientBuilder().build(ossEndPoint,
        //                                         ossAccessId, ossAccessKey);
        ...
        //PutObjectRequest putObjectRequest = new PutObjectRequest(ossBucketName,
        //                                        ossObjectName+"/"+metaFileName, file);
        //try {
